...
async function loadTracks() {
    ...
    console.log('🏁 Iniciando loadTracks...');
    console.log('📦 Container encontrado:', container);
    console.log('📅 calendar2025 tem', calendar2025.length, 'corridas');
    
    // Mapeamento de corridas para chaves do tracksData
    const trackMapping = {
        'Grande Prêmio da Austrália': 'Australia',
        'Grande Prêmio da China': 'China',
        'Grande Prêmio do Japão': 'Japan',
        'Grande Prêmio do Bahrein': 'Bahrain',
        'Grande Prêmio da Arábia Saudita': 'Saudi Arabia',
        'Grande Prêmio de Miami': 'Miami',
        'Grande Prêmio da Emilia-Romagna': 'Imola',
        'Grande Prêmio de Mônaco': 'Monaco',
        'Grande Prêmio da Espanha': 'Spain',
        'Grande Prêmio do Canadá': 'Canada',
        'Grande Prêmio da Áustria': 'Austria',
        'Grande Prêmio da Grã-Bretanha': 'Britain',
        'Grande Prêmio da Bélgica': 'Belgium',
        'Grande Prêmio da Hungria': 'Hungary',
        'Grande Prêmio da Holanda': 'Netherlands',
        'Grande Prêmio da Itália': 'Italy',
        'Grande Prêmio do Azerbaijão': 'Azerbaijan',
        'Grande Prêmio de Singapura': 'Singapore',
        'Grande Prêmio dos Estados Unidos': 'United States',
        'Grande Prêmio do México': 'Mexico',
        'Grande Prêmio do Brasil': 'Brazil',
        'Grande Prêmio de Las Vegas': 'Las Vegas',
        'Grande Prêmio do Catar': 'Qatar',
        'Grande Prêmio de Abu Dhabi': 'Abu Dhabi'
    };
    ...
    calendar2025.forEach((race, index) => {
        const trackKey = trackMapping[race.name];
        const trackInfo = tracksData[trackKey];
        
        console.log(`🔍 Corrida ${index + 1}: ${race.name} → Chave: ${trackKey} → Encontrado: ${!!trackInfo}`);
        
        if (!trackInfo) {
            console.warn(`⚠️ Dados não encontrados para ${race.name} (chave: ${trackKey})`);
            return;
        }
        ...
        container.appendChild(card);
        cardsAdded++;
        console.log(`✅ Card ${cardsAdded} adicionado: ${trackKey}`);
    });
    
    console.log(`🎉 TOTAL: ${cardsAdded} pistas de 2025 carregadas!`);
}
